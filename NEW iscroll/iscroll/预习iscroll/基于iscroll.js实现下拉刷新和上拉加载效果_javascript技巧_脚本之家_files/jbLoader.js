...
/*var ggg;
　　if (getCookie("ggg")=="ok1"){ 
　　　var logo_m='<a href="http://vps.zzidc.com/tongji/jb51.html" target="_blank"><img src="http://files.jb51.net/image/zzidc370-1.gif" width=370 height=60 /></a>';
　　setCookie("ggg","ok2"); 
　　}else if(getCookie("ggg")=="ok2"){
	　var logo_m='<a href="http://vps.zzidc.com/tongji/jb51.html" target="_blank"><img src="http://files.jb51.net/image/zzidc370-2.gif" width=370 height=60 /></a>';
　　setCookie("ggg","ok3"); 
	}else{
	　var logo_m='<a href="http://vps.zzidc.com/tongji/jb51.html" target="_blank"><img src="http://files.jb51.net/image/zzidc370-3.gif" width=370 height=60 /></a>';
　　setCookie("ggg","ok1"); 
	}*/
...
var logo_r='<a href="http://www.eflycloud.com/?from=RJ0011&hmsr=http%3A%2F%2Fwww.jb51.net%2F&hmpl=%E8%84%9A%E6%9C%AC%E4%B9%8B%E5%AE%B6&hmcu=&hmkw=&hmci=" target="_blank"><img src="http://files.jb51.net/image/ruijiangyun.gif" width=370 height=60 /></a>';

var aliyun1000='<div class="mainlr"><a href="http://click.aliyun.com/m/14081/" target="_blank"><img src="http://files.jb51.net/image/ali_1000_2.jpg" alt="cdnoss" width="1000" height="60"></a></div><div class="blank5"></div>';
/*aliyun1000+='<div class="mainlr"><a href="http://www.jcloud.com/service/experience.html?utm_source=jb51&utm_medium=banner&utm_campaign=extend20170307&utm_term=probation&utm_content=middle_imagelink" target="_blank"><img src="http://files.jb51.net/image/jingdongyun.jpg" alt="cdnoss" width="1000" height="60"></a></div><div class="blank5"></div>';
*/
var idctu="";
...
tgtxt+='<li><a href="http://www.zndata.com/chaozhi/" target="_blank"><span style="color:red;">即开美国云28元/香港云39元/韩国云55元</span></a></li>';

tgtxt+='<li><a href="http://www.liuliangdada.com/" target="_blank"><span style="color:blue;">日供百万IP、2亿UV★5元/万、可点击</span></a></li>';
...
tgtxt+='<li><a href="http://wpa.qq.com/msgrd?v=3&uin=122255512&site=qq&menu=yes" target="_blank"><span style="color:red;">推荐！T0第三方支付接口！！秒到抗投诉！</span></a></li>';
...
tonglan1+=ali237;
tonglan1+='<li><A href="http://www.cncloud.com/sale/" target=_blank><IMG alt="" src="http://files.jb51.net/image/cncloud_237.gif" width="237" height="60"></A></li>';
...
tonglan1_2+=ali237;
tonglan1_2+='<li><A href="http://www.cncloud.com/sale/" target=_blank><IMG alt="" src="http://files.jb51.net/image/cncloud_237.gif" width="237" height="60"></A></li>';
...
if(ad_projectlist.indexOf(','+projectName+',')>0){
    $subnav = $(".subnav ul");
	if($subnav){
			$subnav.append('<li><A href="http://90sheji.com/" title="资源下载" style="color:red" target="_blank">资源下载</A></li>');
	}       
}
...
if(ad_projectlist1.indexOf(','+projectName1+',')>0){
    $content = $("#content");
	if($content){
			$content.prepend('<p class="content-lead">2017最全面网络兼职服务，提供淘宝开店，淘宝直播，淘宝信誉兼职等各种服务，数十万网络兼职商家会员推荐，请加<strong>QQ/微信：81197805</strong></p>');
	}       
}else{
